...
## Horrorible
A horror themed platformer where you explore an old mansion and learn the story of the former residents. You cannot attack anything.

## Genre
Classic platformer a la Mario

## Hurdles
 * Writing the story
 * Creating "scary" graphics / atmosphere
 
----
## Physical
A puzzle platformer based on finding your way through levels and avoiding enemies using physics. Ex: there's a hole you can't jump over and some blocks over there: how do you get them to fall into the hole so you can get across?

## Genre
Puzzle / Physics

## Hurdles
 * The whole "physics" things
 * Graphics
 
----
## Swqars
I would like to keep working on the shoot em up game I made for homework. Adding graphics, sound, a story, pickup items, more enemies, etc.

## Genre
Shmup

## Hurdles
 * Producing graphics, sound and story
 * Cutscenes
 * Testing new enemies and pickups, keeping play even
 
----
## Things I'm Good At:
 * Good Coding
 * Lots of ideas, not all of which are good...
 * Leadership